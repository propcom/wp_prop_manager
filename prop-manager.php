    ...
    function add_field( array $args ) {
      ...
      switch ( $args['type'] ) {
        ...
        case 'checkbox' :
          ...
          $val = isset( $this->options[ $args['name'] ] ) ? $this->options[ $args['name'] ] : '';

          printf(

            '<input type="checkbox" id="%1$s" name="prop_%2$s[%1$s]" value="1" %3$s />',
            esc_attr( $args['name'] ),
